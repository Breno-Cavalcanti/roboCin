...
- tensorflow: 2.2.0
# How to test:
- you have 2 options, the first is to run the `test.ipynb` file and see the results by yourself with the cvs file alredy provied. The anothe option is to create a .csv, to do so, follow the next steps:
  ...
  5. After that, get the .csv file and put in the same folder with the file `test.ipynb`, in the third cell replace `test_with_vanishing.csv` for the name of the csv file which you created and see the results.